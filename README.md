...
**Estimated number of unit tests:** ~16,882¹
...
- Each class and function is **individually verified** through unit testing in a real Maya environment.
- Designed to support the same or later Python versions of Maya's interpreter.
    - Maya 2027: 3.13+
    - [Maya 2026: 3.11+](https://store.bencremental.com/l/maya-2026-api-stubs)
    - [Maya 2025: 3.11+](https://store.bencremental.com/l/maya-2025-api-stubs)
    - Maya 2024: 3.10+
    - Maya 2023: 3.9+
    - Maya 2022: 3.7+
- Once full coverage is reached for Maya 2026, **older Maya versions will follow**.
- Stubs will be created in this order: ~~2026~~, ~~2025~~, 2024, 2023, 2027, ...
